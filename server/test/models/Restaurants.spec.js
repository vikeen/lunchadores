...
describe('Restaurants Model', function () {
    ...
    beforeEach(function (done) {
        models.restaurants.destroy({where: {}}).then(function () {
            models.restaurants.bulkCreate(mockRestaurants, {individualHooks: true}).then(function () {
                done();
            }).catch(console.error);
        });
    });
    ...
    it('should default to active on create', function (done) {
        ...
        models.restaurants.create(newRestaurant).then(function (restaurant) {
