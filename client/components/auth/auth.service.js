(function () {
    ...
    AuthFactory.$inject = ["$rootScope", "$http", "$cookieStore", "$q", "User"];
    function AuthFactory($rootScope, $http, $cookieStore, $q, User) {
        ...
        function activate() {
            ...
            /**
             * Waits for currentUser to resolve before checking if user is
             * logged in
             */
